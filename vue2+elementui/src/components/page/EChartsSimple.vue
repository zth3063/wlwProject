...
export default {
  ...
  methods: {
    drawPie() {
      this.$axios2.get("/chart-simple/pie").then(res => {
    ...
    drawLine() {
      this.$axios2.get("/chart-simple/line").then(res => {
    ...
    drawBar() {
      this.$axios2.get("/chart-simple/bar").then(res => {
    ...
    drawGauge() {
      ...
      this.$axios2.get("/chart-simple/gauge").then(res => {
    ...
    drawRadar() {
      this.$axios2.get("/chart-simple/radar").then(res => {
  ...
  mounted() {
    ...
    this.drawPie2().drawLine().drawBar().drawGauge().drawRadar().resizeChart();
  }
};
</script>
